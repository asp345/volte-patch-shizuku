...
1. [다음 링크](https://github.com/kyujin-cho/pixel-volte-patch/releases/download/1.0.0/dev.bluehouse.enablevolte.apk) 혹은 이 Github Repository의 Releases 탭으로 이동하여 최신 패치 어플리케이션의 설치를 위한 APK 파일을 Pixel 단말기에 다운로드 받습니다.
...
### 앱을 켜자마자 꺼지는 경우 Shizuku를 먼저 설치, 권한 부여 후 실행해주세요
